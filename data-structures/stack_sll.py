...
class Stack:
    ...
    def push(self, value: object) -> None:
        """
        Pushes a new value onto the top of the stack. O(1) complexity.

        Receives: value to push
        Returns: nothing
        """
    ...
    def pop(self) -> object:
        """
        Pops a value off tha top of the stack. O(1) complexity.
    ...
    def top(self) -> object:
        """
        Returns the element at the top of the stack without removing it. O(1) complexity. Returns StackException if stack is empty.
