...
Model Architecture
The model architecture consists of _____________________________________.

Training
The model was trained on the MNIST dataset, which contains 60,000 training images and 10,000 test images of handwritten digits. The training process involved ____________________________.
